...
function About() {
  ...
  return (
    <Container className="mainFont" style={{textAlign:"justify"}}>
      ...
      <p>
          As all UPRM students know, chemistry is a compulsory
          subject. Many of these UPRM students do not course
          ...
          analyze it, solve it and provide an explanation of how
      ...
      <h2>Needs & Ideas</h2>
      <p>
          There is a need for students, educators, and
          researchers to help them facilitate and solve their
          chemistry problems. This app is designed in a simple
          yet understandable way in order to improve the
          problem solving time of said users so they can gain
          ...
          camera. The app should be able to solve the
          chemistry problems and show the step-by-step process
      ...
      <p>
          The user can choose the branch/level of chemistry
          they need help with. They can input images of
          problems or input the equations and symbols
          manually. The app will include tools to get the
          user help solving and explaining their chemistry
          problems via a photo they take, a picture they
          already have or manually written problems.
      </p>
    </Container>
